              ...
              <form name="form1" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <input type="text" class="form-control"  placeholder="브랜드 명" name="brand_name">
                  </div>
                  <div class="form-group">
					<div id="preview"></div>
                ...
                <div class="card-footer">
                  <button type="button" class="btn btn-info" id="bt_regist">등록하기</button>
...
function regist(){
	form1.action="/admin/brand/regist";
	form1.method="post";
