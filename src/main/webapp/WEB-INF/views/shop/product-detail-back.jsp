				...
				<div class="tab01">
					...
					<div class="tab-content p-t-43">
						...
						<div class="tab-pane fade" id="reviews" role="tabpanel">
							<div class="row">
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto" >
									<div class="p-b-30 m-lr-15-sm" id ="review-list">
										<!-- Review -->
...
function printTable(json){
	...
	for(var i=0;i<json.length;i++){
		...
		var tag = "<div class='flex-w flex-t p-b-68'>";
		
		tag+="<div class='wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6'>";
		tag +="<img src='/resources/funfume/images/avatar-01.jpg' alt='AVATAR'>";
		tag +="</div>";
		...
		tag += "<form class='w-full'>";
		tag += "<h5 class='mtext-108 cl2 p-b-7'>";
		tag += "Add a review";
		tag += "</h5>";
		tag += "<p class='stext-102 cl6'>";
		tag += "Your email address will not be published. Required fields are marked *";
		tag += "</p>";
		tag += "<div class='flex-w flex-m p-t-50 p-b-23'>";
		tag += "<span class='stext-102 cl3 m-r-16'>";
		tag += "<span class='stext-102 cl3 m-r-16'>";
		tag += "Your Rating";
		tag += "</span>";
		tag += "<span class='wrap-rating fs-18 cl11 pointer'>";
		tag += "<i class='item-rating pointer zmdi zmdi-star-outline'></i>";
		tag += "<i class='item-rating pointer zmdi zmdi-star-outline'></i>";
		tag += "<i class='item-rating pointer zmdi zmdi-star-outline'></i>";
		tag += "<i class='item-rating pointer zmdi zmdi-star-outline'></i>";
		tag += "<i class='item-rating pointer zmdi zmdi-star-outline'></i>";
		tag += "<input class='dis-none' type='number' name='rating'>";
		tag += "</span>";
		tag += "</div>";
		tag += "<div class='row p-b-25'>";
		tag += "<div class='col-12 p-b-5'>";
		tag += "<label class='stext-102 cl3' for='review'>Your review</label>";
		tag += "<textarea class='size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10' id='review' name='review'></textarea>";
		tag += "</div>";
		tag += "<div class='col-sm-6 p-b-5'>";
		tag += "<label class='stext-102 cl3' for='name'>Name</label>";
		tag += "<input class='size-111 bor8 stext-102 cl2 p-lr-20' id='name' type='text' name='name'>";
		tag += "</div>";
		tag += "<div class='col-sm-6 p-b-5'>";
		tag += "<label class='stext-102 cl3' for='email'>Email</label>";
		tag += "<input class='size-111 bor8 stext-102 cl2 p-lr-20' id='email' type='text' name='email'>";
		tag += "</div>";
		tag += "</div>";
		tag += "<button type='button' class='flex-c-m stext-101 cl0 size-112 bg7 bor11 hov-btn3 p-lr-15 trans-04 m-b-10' id='bt_regist'>";
		tag += "Submit";
		tag += "</button>";
		tag += "</form>";
