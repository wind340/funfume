...
<%
	List<Product> product = (List)request.getAttribute("searchList");
%>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<!-- <div class='col-sm-6 col-md-4 col-lg-3 p-b-35'>
				<div class='block2'>
					<div class='block2-pic hov-img0'>
						<img src='/resources/data/"+json.productImgs[0].img+"' width='200' height='350'>
						</div>
							<div class='block2-txt flex-w flex-t p-t-14'>
								<div class='block2-txt-child1 flex-col-l '>
								<a href='/product-detail?product_id="+json.product_id+"' class='stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6'>
								product_name</a>
